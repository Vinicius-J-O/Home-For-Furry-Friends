...
public class TelaProcedimento extends JFrame {
    ...
    private JTextArea txtDescricao; // Caixa de texto com várias linhas pra descrição
    ...
    // Pega todos os procedimentos no banco de dados e preenche a tabela.
    ...
    private void salvar() {
        ...
        try {
            // Tenta converter o texto do campo Valor em número (double).
            ...
            // Vem pra cá se o usuário digitar algo que não seja um número válido no campo Valor.
